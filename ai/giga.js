...
2. Удали все упоминания о подписях, рекламных сообщениях, любых других несвязанных элементах и ссылках на источники.
3. Не добавляй новые детали, мнения или интерпретации. Текст должен быть максимально точным и соответствовать исходному.
...
6. Не указывай ссылки на источники или другие внешние материалы.

Контекст: ${context}

Исходный текст: ${text}

Перепиши текст так, чтобы он выглядел как новостная лента, с минимальными изменениями формулировок, сохраняя оригинальный смысл и убирая лишние элементы, в том числе ссылки и источники.`
